...
call <sid>hi("Folded", s:gray, s:white, "none")
...
call <sid>hi("NonText", s:black, s:black, "none")
call <sid>hi("Normal", "none", "none", "none")
call <sid>hi("PMenu", s:gray, s:white, "none")
call <sid>hi("PMenuSel", s:blue, s:white, "bold")
...
call <sid>hi("StatusLine", s:gray, s:green, "none")
call <sid>hi("StatusLineNC", s:gray, s:yellow, "none")
call <sid>hi("StatusLineTerm", s:gray, s:green, "none")
call <sid>hi("StatusLineTermNC", s:gray, s:yellow, "none")
call <sid>hi("TabLine", "none", s:yellow, "none")
call <sid>hi("TabLineFill", "none", "none", "none")
call <sid>hi("TabLineSel", "none", s:green, "none")
...
call <sid>hi("DiffAdd", s:gray, s:green, "none")
call <sid>hi("DiffChange", s:gray, s:red, "none")
call <sid>hi("DiffDelete", "none", s:red, "none")
call <sid>hi("DiffText", s:gray, s:red, "none")
call <sid>hi("Float", "none", s:cyan, "none")
...
call <sid>hi("Special", "none", s:cyan, "none")
