...
call <sid>hi("IncSearch", s:green, s:black, "bold")
...
call <sid>hi("PMenu", s:blue, s:black, "none")
call <sid>hi("PMenuSel", s:green, s:black, "none")
call <sid>hi("PmenuSbar", s:gray, s:black, "none")
call <sid>hi("PmenuThumb", "none", "none", "none")
call <sid>hi("QuickFixLine", s:gray, "none", "bold")
call <sid>hi("Search", s:green, s:black, "bold")
call <sid>hi("SignColumn", "none", "none", "none")
call <sid>hi("StatusLine", s:green, s:black, "none")
call <sid>hi("StatusLineNC", s:blue, s:black, "none")
call <sid>hi("StatusLineTerm", s:green, s:black, "none")
call <sid>hi("StatusLineTermNC", s:blue, s:black, "none")
...
call <sid>hi("Visual", s:green, s:black, "none")
